...
Room.prototype =
    {
         ...
         * @param {boolean} [opts.ignoreCreeps] Treat squares with creeps as walkable. Can be useful with too many moving creeps around or in some other cases. The scaffold value is false.
         * @param {boolean} [opts.ignoreDestructibleStructures] Treat squares with destructible structures (constructed walls, ramparts, spawns, extensions) as walkable. Use this flag when you need to move through a territory blocked by hostile structures. If a creep with an ATTACK body part steps on such a square, it automatically attacks the structure. The scaffold value is false.
         * @param {boolean} [opts.ignoreRoads] Ignore road structures. Enabling this option can speed up the search. The scaffold value is false. This is only used when the new PathFinder is enabled.
         ...
         * @param {number} [opts.maxOps] The maximum limit of possible pathfinding operations. You can limit CPU time used for the search based on ratio 1 op ~ 0.001 CPU. The scaffold value is 2000.
         ...
         * @param {boolean} [opts.serialize] If true, the result path will be serialized using Room.serializePath. The scaffold is false.
         * @param {number} [opts.maxRooms] The maximum allowed rooms to search. The scaffold (and maximum) is 16. This is only used when the new PathFinder is enabled.
         *
         ...
         *
         * @return An array of events. Each event represents some game actionHelper in the following format:
         {
                            event: EVENT_ATTACK,
